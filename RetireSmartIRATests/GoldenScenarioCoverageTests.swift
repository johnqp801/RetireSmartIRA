...
struct GoldenScenarioCoverageTests {
    ...
    /// does not exist yet.
    static let covered: [String] = ["PA", "IL", "MS", "NJ", "NY", "AK", "FL", "NV", "SD", "TN", "TX", "WY", "NH", "CA", "NE", "ND", "IN", "OR", "CO", "KY", "GA", "MO", "IA", "MI", "CT", "VA", "WI", "AL", "RI", "ME", "MD", "KS", "MA", "HI", "AZ", "NC", "ID", "VT", "DC", "OK", "DE", "LA", "AR", "SC", "WV"]
