# Task 4 brief: no retirement exclusion, confirmed correct


---

Assembled from the plan's global constraints, the four-case matrix, the fixture shape invariant, the shared batch procedure, and Task 4's own notes. All of it binds you.
