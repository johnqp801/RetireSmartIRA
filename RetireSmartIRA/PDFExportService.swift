...
struct PDFExportService {
    ...
    private static func htmlHeader(taxYear: Int) -> String {
        ...
        <div style="text-align:center; margin-bottom:16px;">
            ...
            <p class="muted">PlanSmart IRA &bull; \(taxYear) Tax Year &bull; Prepared \(dateStr)</p>
        </div>
        """
    }
    ...
    private static func htmlFooter() -> String {
        ...
        <div class="disclaimer">
            ...
            <p>Generated by PlanSmart IRA v\(version)</p>
        </div>
        </body></html>
        """
    }
    ...
    private static func sectionWhatYouOwe(_ d: PDFExportData) -> String {
        ...
        if qp.total > 0 {
            ...
            html += "<p class=\"muted\">Based on 90% safe harbor rule. Withholding from income sources has been credited.</p>"
        }
